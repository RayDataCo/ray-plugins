...
>
> **This is a living document, not a frozen asset.** Copilot Studio changes fast. Pull a copy into your working project with the **`copilot-studio-pull-runbook`** skill, and refresh it against the latest Microsoft Learn docs with the **`copilot-studio-ground-runbook`** skill before relying on it.
...
---
_Last grounded against Microsoft Learn: 2026-06-08 (initial build from the verified handoff spec). Re-run the `copilot-studio-ground-runbook` skill to refresh and update this date._
