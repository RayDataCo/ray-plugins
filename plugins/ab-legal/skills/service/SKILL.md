...
differs by kind. The factory walks a rail of build tickets; a discipline brigade's primary
path is `fire` (an ad-hoc request straight to the [expo](../expo/)), so service here is
thin: it gates readiness and declares the brigade open.
