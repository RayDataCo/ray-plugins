...
| US state statutes/regulations (the operative law text) | `public-domain` | Public edict per *Georgia v. Public.Resource.Org*, 590 U.S. 255 (2020) — extends to official annotations authored by a legislature's own agent. | `INCLUDE` |
